...
/// 支持 pan/zoom，默认 80 根，最小 30，最大 200
class ChartViewportController extends ChangeNotifier {
  ChartViewportController({
    ...
    this.maxVisibleCount = 200,
  }) : _visibleCount = initialVisibleCount.clamp(30.0, 200.0);
  ...
  /// 使用 candleWidth 映射并乘以系数，避免轻微滑动就跳很多根
  static const double _panFactor = 0.5;
