...
class ChartTheme {
  ...
  // ── TradingView 风格（桌面端） ─────────────────────────────────
  static const Color tvBackground = Color(0xFF131722);
  static const Color tvTopBarBg = Color(0xFF1E222D);
  static const Color tvBorder = Color(0xFF2A2E39);
  static const Color tvTextActive = Color(0xFFD1D4DC);
  static const Color tvTextMuted = Color(0xFF787B86);
  static const double tvNavBarHeight = 40.0;
  static const double tvTimeframeBarHeight = 36.0;
  static const double tvSidePanelWidth = 280.0;
