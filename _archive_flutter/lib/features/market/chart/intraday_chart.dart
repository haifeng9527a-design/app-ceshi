  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // 注意：_buildChartContent 外层 Padding(0,8,4,8) 占 16px，effectiveTotalBottom 含 volumeOverhead 4px
        // 这 20px 不在 totalNeeded 里，需从 maxTotalH 中预先扣除，保证缩放后总高度不超出约束。
        const volumeOverhead = 4.0;
        const paddingOverhead = 16.0; // EdgeInsets.fromLTRB(0,8,4,8) top+bottom
        final maxTotalH = (constraints.maxHeight - paddingOverhead - volumeOverhead).clamp(100.0, double.infinity);
